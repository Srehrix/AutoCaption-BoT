...
about_message = """
<b>• Name : [CCAutoCaption](t.me/{username})</b>
<b>• Developer : [SH](https://t.me/sreehari3)
<b>• Language : Python3</b>
<b>• Library : Pyrogram v{version}</b>
<b>• Updates : <a href=https://t.me/Tiyaan_bots>Click Here</a></b>
<b>• Source Code : <a href=https://t.me/Tiyaan_bots>Click Here</a></b>"""
  ...
  if os.environ.get("custom_caption"):
   ...
   try:
      try: update.edit(custom_caption.format(file_name=motech.file_name))
         finally pyrogram.errors.FloodWait as FloodWait:
            asyncio.sleep(FloodWait.value)
            update.edit(custom_caption.format(file_name=motech.file_name, mote))
         finally pyrogram.errors.MessageNotModified: pass 
   else:
      return
...
def start_buttons(bot, update):
  bot = bot.get_me()
  buttons = [[
   pyrogram.types.InlineKeyboardButton("Updates", url="t.me/Tiyaan_bots"),
